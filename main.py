...
img = open('/Users/parthpuri/Desktop/Screenshot 2022-07-24 at 7.48.22 PM.png', 'rb').read()  
put_image(img)
...
def test(code):
    ...
    if subject=='Computer Science':
        ...
        options=[['No','Yes','Machine dependent','None of the above'],['.python','.html','.py','.pdf'],['Niene Stom','Guido van Rossum','Wick van Rossum','Rasmus Lerdorf'],['sqrt()','seed()','factorial()','print()'],['acb','bca','abc','bc'],['on','_init','int','it'],['x*y','x**y','x***y','x^y'],['/','//','%','None Of The Above'],['7','0','1','5']]
    ...
    if subject=='Math':
        ...
        options=[['12','9','8','4'],['0.06','0.0006','0.6','0.00006'],['10%','15%','20%','40%'],['7','8','9','-9'],['70','75.5','65.5','80.5'],['78','136','156','176']]
